 ...
 *  ERROR_PARSED flags a known error, successfully parsed as JSON.
    Stops reading, this is a terminal state
 *  ERROR_UNPARSED flags an unknown error that we are not able to parse.
    Keeps reading to try to complete the error
 * */
const STATES = {
