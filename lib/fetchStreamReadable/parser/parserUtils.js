...
const isMetadata = (event) => event && (event.metadata || event.m);
...
const homogenizeErrorFormat = (errorParsed, statusCode) => {
  ...
  if (!errorParsed.msg && errorParsed.object
    && errorParsed.object.error && errorParsed.object.error[0]) {
